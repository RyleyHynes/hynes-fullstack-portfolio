    ...
    <section className="grid gap-6">
      ...
      <div className="grid lg:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)] gap-6">
        <div className="card p-6">
          ...
          <CardHeader
            title="Alpine Guide Pack"
            subtitle="Built for high-output days with room for safety gear, water, and layers."
          />
          <p className="mt-2 text-xs text-slate-400">Product ID: {productId}</p>
        </div>
